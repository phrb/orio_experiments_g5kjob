...
USR="pbruel"
USR_TARGET="/home/${USR}/dlmt_spapt_experiments/data/results/trmm"
NODE_NAME="xeon_e5_2630_v3_$(uname -n | cut -d. -f1)"

APP_TARGET="/root/dlmt_spapt_experiments/orio/testsuite/SPAPT/trmm"
cd $APP_TARGET

./run_multiple.sh 1 trmm.c
...
./run_multiple.sh 1 trmm_random.c
